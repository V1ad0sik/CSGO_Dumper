...
class RecvProp:
    ...
    def get_data_table(self) -> "RecvTable":
        return RecvTable(self._handle.read_int(self._start_addr + 0x28), self._handle)
...
class ClientClass:
    ...
    def get_next_class(self) -> "ClientClass":
        return self.__class__(self._handle.read_int(self._start_addr + 0x10), self._handle)
 
    def get_table(self) -> RecvTable:
        return RecvTable(self._handle.read_int(self._start_addr + 0xC), self._handle)